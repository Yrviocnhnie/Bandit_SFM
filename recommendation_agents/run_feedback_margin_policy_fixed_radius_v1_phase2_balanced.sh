...
OUTPUT_DIR="${OUTPUT_DIR:-${ARTIFACT_DIR}/feedback_margin_policy_fixed_radius_v1_phase2_balanced}"
DEVICE="${DEVICE:-cpu}"
CROSS_SCENARIO_SAMPLE_SIZE="${CROSS_SCENARIO_SAMPLE_SIZE:-2000}"
MIN_NEIGHBORS="${MIN_NEIGHBORS:-500}"
MAX_NEIGHBORS="${MAX_NEIGHBORS:-2000}"
