...
| Occurs in rules, history | `precondition` | Yes | Yes | categorical | 64 canonical `StateCode` values + `unknown` | one-hot | 65 | Main semantic summary of the current situation. |
